...
public interface WorkspaceMemberRepository extends JpaRepository<WorkspaceMember, Integer> {
    ...
    List<WorkspaceMember> findByWorkspaceIdAndRole(Integer workspaceId, WorkspaceMember.Role role);

    Long countByWorkspaceIdAndRole(Integer workspaceId, WorkspaceMember.Role role);
